...
Processing is actually all of the culling - de-duping, threading, keyword refinement, using the relevance module
...
The above step describes processing, not Analysis. Analysis is getting an overview of the data (think early case assessment here) and performing a litigation gap analysis.  
https://www.edrm.net/resources/frameworks-and-standards/edrm-model/analysis/
